...
public class DbOperations {
    ...
    public static void createRecord(String line) {
        Student studentObj;
        try {
            ...
            studentObj.setStudentName(attrs[1]);
            studentObj.setCity(attrs[2]);
            studentObj.setAge(Integer.valueOf(attrs[3]));
    ...
    public static void updateRecord(int student_id) {
        try {
            ...
            stuObj.setCity("Masters Of Technology");
